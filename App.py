 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "lastdate\n",
    "#t.date.strptime(str(lastdate[0]),'%Y-%m-%d')"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.axes._subplots.AxesSubplot at 0x1d8051f7b38>"
      ]
     },
     "execution_count": 42,
     "metadata": {},
    ...
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
   ...
   "source": [
    ...
    "oneyeardata = session.query(Measurement.date, Measurement.prcp).filter(Measurement.date>=lastdate).all()\n",
    "\n",
    "# Save the query results as a Pandas DataFrame and set the index to the date column\n",
    "df = pd.DataFrame(oneyeardata, columns=['date','prcp'])\n",
    "\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.axes._subplots.AxesSubplot at 0x1d8050c27b8>"
      ]
     },
     "execution_count": 70,
     "metadata": {},
